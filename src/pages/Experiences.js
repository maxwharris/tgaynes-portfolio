  ...
  return (
    <div className="page">
      <div className="page-header">
        ...
        <p className="page-subtitle">Professional experience and background</p>
      </div>
          ...
          {resumeData.map((job, index) => (
            ...
            >
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontWeight: '600', fontSize: '16px' }}>{job['Job Title']}</div>
            ...
            activeTab === index && (
              <div key={index} className="tab-pane active">
                ...
                <div className="job-skills">
                  <h5 style={{ marginBottom: '12px', fontSize: '16px', fontWeight: '600', color: '#000' }}>
                    Skills & Technologies
                  </h5>
